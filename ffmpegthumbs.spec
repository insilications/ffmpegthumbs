...
Version  : 20.12.1
Release  : 19
URL      : file:///insilications/build/clearlinux/packages/ffmpegthumbs/ffmpegthumbs-v20.12.1.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/ffmpegthumbs/ffmpegthumbs-v20.12.1.tar.gz
...
%prep
%setup -q -n ffmpegthumbs
cd %{_builddir}/ffmpegthumbs
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610855416
mkdir -p clr-build
pushd clr-build
