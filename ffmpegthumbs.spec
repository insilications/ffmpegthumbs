...
Version  : 19.04.0
Release  : 2
URL      : https://download.kde.org/stable/applications/19.04.0/src/ffmpegthumbs-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/ffmpegthumbs-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/ffmpegthumbs-19.04.0.tar.xz.sig
...
%prep
%setup -q -n ffmpegthumbs-19.04.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1557084597
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
