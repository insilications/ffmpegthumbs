...
Version  : 19.12.0
Release  : 10
URL      : https://download.kde.org/stable/release-service/19.12.0/src/ffmpegthumbs-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/ffmpegthumbs-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/ffmpegthumbs-19.12.0.tar.xz.sig
...
%prep
%setup -q -n ffmpegthumbs-19.12.0
cd %{_builddir}/ffmpegthumbs-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576544268
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ffmpegthumbs-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/ffmpegthumbs/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/ffmpegthumbs-19.12.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/ffmpegthumbs/77976f406ba34009d9ba5a43b882fe6de68e5175
pushd clr-build
%make_install
popd
